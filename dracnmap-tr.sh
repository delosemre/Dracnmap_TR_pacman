...
#============================================================================================================
#                         Dracnmap for dracos
#                Edit: S0lid Night (delosemre)/ BlinkCursor
...
ctrl_c() {
clear
echo -e $red"[*] (Ctrl + C ) Algilandi, Çikis Yapiliyor ..."
sleep 1
echo ""
echo -e $yellow"[*] Dracnmap Kullanimi Icin Tesekkur Ederiz  =)."
echo ""
...
#Bebeku
if [[ $EUID -ne 0 ]]; then
	echo "HATA! Bu komut dosyasini root kullanicisi ile calistirin!"
	exit 1
fi
...
function scanoutput() {
  ...
  echo " |_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_| "
    echo -e $white " "
    echo -e $white"	[$okegreen"01"$white]$okegreen  XML FORMATLARINDA ÇIKTI TARAMA"
    echo -e $white"	[$okegreen"02"$white]$okegreen  HTML FORMATLARINDA ÇIKTI TARAMA "
    echo -e $white"	[$okegreen"03"$white]$okegreen  NORMAL FORMATLARDA ÇIKTI TARAMA  "
    echo -e $white"	[$okegreen"04"$white]$okegreen  GREPABLE FORMATLARINDA ÇIKTI TARAMA "
    echo -e $white"	[$okegreen"05"$white]$okegreen  GERI  "
    echo -e " "
    echo -n -e $red'  \033[4mScreetsec@Meoong:\033[0m>> '; tput sgr0 #insert your choice
           ...
           if test $DrS == '1'
        	 ...
        	 read namafile
                 echo
                 echo -ne "  Hedef IP adresi veya host adresi? "
                 read ip
                 echo
        	  ...
        	  then
                  ...
                  then
                	menu
       			  	...
       			  	echo -e "  Yanlis Numara"
        			fi
        			echo -n -e " Son Menuye Donmek? ( Yes / No ) :"
       			read back
	    ...
	    echo -n -e $red'  \033[4mScreetsec@nse-brute:\033[0m>> '; tput sgr0 #insert your choice
	      	read Brute
	             if test $Brute == '1'
	          	then
	          		echo
	          		echo -ne $okegreen " Hedef IP adresi veya host adresi? : " ; tput sgr0
	           		read ip
	              echo -ne $okegreen " Open Port on Target or Host:  " ; tput sgr0
	                ...
	                then
	                	echo
	                	echo -ne $okegreen " Hedef IP veya host adresi nedir?: " ; tput sgr0
	                  read ip
	            ...
	            then
	             ...
	             then
	              ...
	              then
	              	echo
	              	echo -ne $okegreen " Hedef IP veya host adresi? " ; tput sgr0
	                read ip
	              ...
	              then
	               ...
	               then
	                nse
	                 ...
	                 echo ""
	                 echo -e $okegreen " Yanlis Numara"
	               fi
	               		echo ""
	               		echo ""
	               		echo -n -e $red " Son Menuye Donmek? ( Yes / No ) :"
	             read back
	             if [ $back != 'n' ] && [ $back != 'N' ] && [ $back != 'no' ] && [ $back != 'No' ]
	                 then
	                 clear
...
clear
  ...
  echo -n -e $red'  \033[4mScreetsec@nse-broadcast:\033[0m>> '; tput sgr0 #insert your choice
        ...
        if test $min == '1'
          then
          echo
          echo -ne $okegreen " Arayuzleriniz Nedir" ; tput sgr0
          read ie
          $xterm --script broadcast-ataoe-discover -e $ie &
        elif test $min == '2'
          then
          echo
          echo -ne $okegreen " Arayuzleriniz Nedirs" ; tput sgr0
          read ie
          ...
          then
          echo
          echo -ne $okegreen " IP ADRESI VEYA SITE ADRESI: " ; tput sgr0
          read ip
          echo -ne $okegreen " What is your Interfaces" ; tput sgr0
          read ie
          ...
          then
          echo
          echo -ne $okegreen " Arayüzleriniz Nedir" ; tput sgr0
          read ie
          ...
          echo -ne $okegreen " Arayuzleriniz Nedir" ; tput sgr0
          read ie
          echo -ne $okegreen " TTL icin varsayilan değer 64 ve yukun uzunluğu 0" ; tput sgr0
          read ttl
          echo -ne $okegreen " The payload is consisted of random bytes." ; tput sgr0
          read payload
          echo -ne $okegreen " Yanit beklemek icin ne kadar sure onereceğini belirten Timespec (varsayiilan 3 sn)" ; tput sgr0
          read ti
          echo -ne $okegreen " Kac tane ICMP sondasinin gonderileceğini belirten numara (varsayilan 1)" ; tput sgr0
          read np
          ...
          then
          echo
          echo -ne $okegreen " Hedefleriniz nedir" ; tput sgr0
          read ip
...
function malware () {
  ...
  echo -e $white"	[$okegreen"09"$white]$cyan smtp-strangeport	"
	echo -e $white"	[$okegreen"10"$white]$cyan geri	"
	echo
...
echo -n -e $red'  \033[4mScreetsec@nse-vuln:\033[0m>> '; tput sgr0 #insert your choice
      ...
      if test $vuln == '1'
        ...
        then
        echo
        echo -ne $okegreen " What is Hedef IP adresi veya host adresi?: " ; tput sgr0
        read ip
...
echo "                                                          ";
echo -e $red"  Nmap Komut Motoru - Nmap Komut Dosyasiyla Gelismis Tarama "

				echo -e $white " "
				echo -e $white"	[$okegreen"01"$white]$cyan  Kimlik doğrulama kategorisi  "
				echo -e $white"	[$okegreen"02"$white]$cyan  Yayin kategorisi "
				echo -e $white"	[$okegreen"03"$white]$cyan  Kaba(brute)-kategori "
				echo -e $white"	[$okegreen"04"$white]$cyan  exploit-katagori "
				echo -e $white"	[$okegreen"05"$white]$cyan  fuzzer-katagori "
				echo -e $white"	[$okegreen"06"$white]$cyan  malware-katagori "
				echo -e $white"	[$okegreen"07"$white]$cyan  vuln-katagori "
				echo -e $white"	[$okegreen"08"$white]$cyan  menuye don "
				echo
										...
										then
										 menu
											...
											echo -e $okegreen " Yanlis Numara "
											 ...
											 echo ""
											 echo ""
											 echo -n -e $red " Son Menuye Donmek istiyor musunuz? ( Yes / No ) :"
									read back
									if [ $back != 'n' ] && [ $back != 'N' ] && [ $back != 'no' ] && [ $back != 'No' ]
											then
											clear
...
function pingbebeb() {
  ...
  echo -e $okegreen"   (_/ alf \_)         "
	echo ""
	echo -e $okegreen" ====================================================================="
	echo -e $cyan "      IP protokuller hakkinda $red'bilgi toplama   "
	echo -e $okegreen" ====================================================================="
	echo ""
    ...
    echo -e $white"	[$okegreen"07"$white]$cyan  Geri  "
    echo -e " "
    echo -n -e $red'  \033[4mScreetsec@PING!:\033[0m>> '; tput sgr0 #insert your choice
           ...
           if test $DrS == '1'
        	  then
                  echo -e $cyan""
                  echo -n "  Hedef IP adresi veya host adresi?: " ; tput sgr0
           	  read ip
              ...
              echo ""
              echo ""
        			echo -n -e $cyan " Son Menuye Don? ( Yes / No ) :"
       			read back
       			if [ $back != 'n' ] && [ $back != 'N' ] && [ $back != 'no' ] && [ $back != 'No' ]
       					then
       					clear
...
echo ""
echo -e $okegreen" ====================================================================="
echo -e $cyan "      Gelismis komut ile  $red'hedef tarama  ( Zenmap Command )  "
echo -e $okegreen" ====================================================================="
echo ""
echo ""
  echo -e $white"	[$okegreen"01"$white]$cyan  AÇIK TARAMA"
  echo -e $white"	[$okegreen"02"$white]$cyan  ITENSE TARAMA + UDP "
  echo -e $white"	[$okegreen"03"$white]$cyan  TuM TCP PORTLARINDA AÇIK TARAMA "
  echo -e $white"	[$okegreen"04"$white]$cyan  HIZLI TARAMA "
  echo -e $white"	[$okegreen"05"$white]$cyan  HIZLI TARAMA + + "
  echo -e $white"	[$okegreen"06"$white]$cyan  QUICK TRACEROUT   "
  echo -e $white"	[$okegreen"07"$white]$cyan  KAPSAMLI TARAMA [BEST]  "
  echo -e $white"	[$okegreen"08"$white]$cyan  GERI "
	echo -e 	" "
...
echo ""
  ...
  echo " -----------------------------------------------------------------------"
  echo ""
    echo -e $white"	[$okegreen"01"$white]$cyan  WEB UYGULAMA GuVENLIK DUVARLARININ TESPIT EDILMESI  "
    echo -e $white"	[$okegreen"02"$white]$cyan  XST AÇIKLARININ TESPIT EDILMESI "
    echo -e $white"	[$okegreen"03"$white]$cyan  AÇIK RELAYS ALGILAMA "
    echo -e $white"	[$okegreen"04"$white]$cyan  BACKDOOR SMTP SUNUCULARINI ALGILAMA "
    echo -e $white"	[$okegreen"05"$white]$cyan  GEÇERLI ZARARLILARI KESME IŞARETI YAZDIRMA  "
    echo -e $white"	[$okegreen"06"$white]$cyan  KULLANICILARIN SMTP SUNUCUDA SUNULMASI "
    echo -e $white"	[$okegreen"07"$white]$cyan  SLOWLORIS DDOS'TA ZARARLI WEB SUNUCULARININ TESPIT EDILMESI  "
    echo -e $white"	[$okegreen"08"$white]$cyan  SQL ENJEKSIYON ZARARLILARI BULMA  "
    echo -e $white"	[$okegreen"09"$white]$cyan  NSE ile IP JEOLOKASYONU KONTROL EDIN "
    echo -e $white"	[$okegreen"10"$white]$cyan  WHOIS'DEN BILGI BILGILERI TOPLAR (NSE)  "
    echo -e $white"	[$okegreen"11"$white]$cyan  YETERLI EMAIL ADRESINI TOPLAMAK  "
    echo -e $white"	[$okegreen"12"$white]$cyan  GERI  "
    echo -e " "
...
echo -e $cyan"    Edit                $white":" $red S0lid Night (delosemre) "
echo -e $cyan "   instagram						$white":" $red delosemree "
echo -e $cyan""
echo -e $okegreen"    =========================================================    ";
		echo -e $white " "
		echo -e $white"	[$okegreen"01"$white]$cyan  Duzenli Tarama "
    echo -e $white"	[$okegreen"02"$white]$cyan  Çoklu Site/Ip Tarama"
		echo -e $white"	[$okegreen"03"$white]$cyan  Hedef Site Isletim Sisteminin Tespiti "
    echo -e $white"	[$okegreen"04"$white]$cyan  ⁠⁠⁠Host uzerinde Guvenlik Duvari Tarama  "
		echo -e $white"	[$okegreen"05"$white]$cyan  Gizli Guvenlik Duvari "
    echo -e $white"	[$okegreen"06"$white]$cyan  PING PING !!   "
    echo -e $white"	[$okegreen"07"$white]$cyan  Web Servisi"
		echo -e $white"	[$okegreen"08"$white]$cyan  Nse Script uzerinden Bruteforce   "
		echo -e $white"	[$okegreen"09"$white]$cyan  Gelismis Nmap Tarama "
		echo -e $white"	[$okegreen"10"$white]$cyan  Çikti Dosyalari Ile Hedef Tarama "
		echo -e $white"	[$okegreen"11"$white]$cyan  Kredi  "
		echo -e $white"	[$okegreen"12"$white]$cyan  Cikis "
		echo -e " "
      ...
      then
    echo -e $cyan""
    echo -ne "  Hedef IP adresi veya host adresi?: " ; tput sgr0
    read ip
    $xterm  $ip &
 			...
 			then
    echo ""
    echo -ne $okegreen"  Hedef IP adresi veya host adresi? (1): " ; tput sgr0
    read ip1
    echo ""
    echo -ne $okegreen " Hedef IP adresi veya host adresi? (2): " ; tput sgr0
    read ip2
    echo ""
    echo -ne $okegreen " Hedef IP adresi veya host adresi? (3): " ; tput sgr0
    read ip3
    echo ""
    $xterm  $ip1 $ip2 $ip3  &
      ...
      then
        ...
        exit
			...
			echo -n -e "  Çikmak istiyor musun? ( Yes / No ) :"
			read back
			if [ $back != 'n' ] && [ $back != 'N' ] && [ $back != 'no' ] && [ $back != 'No' ]
					then
					clear
...
echo -e $cyan"    Follow me on Github $white":" $red @Screetsec "
echo -e $cyan"    Dracos Linux        $white":" $red dracos-linux.org "
echo -e $cyan"    Turkce Edit         $white":" $red S0lid Night (delosemre) "
echo -e $cyan "   instagram	      $white":" $red delosemree"
echo -e $cyan""
echo -e $okegreen"    =========================================================    ";
		echo -e $white " "
